...
class NotepadGUI:
    ...
    def manageInfo(self, state = 0):
        ...
        fixedWidth = IntVar()
        # Arial and Large
        if(self.notepad.font == "Arial" and self.notepad.fontSize == 20):
            fixedHeight.set(10)
            fixedWidth.set(24)
        elif(self.notepad.font == "Times New Roman" and self.notepad.fontSize == 14):
            fixedHeight.set(14)
            fixedWidth.set(39)
        elif(self.notepad.font == "Times New Roman" and self.notepad.fontSize == 20):
            fixedHeight.set(10)
            fixedWidth.set(26)
...
class Memos:
    def __init__(self):
        ...
        self.rbFontLarge = Radiobutton(self.customizeFrame, text = "Large", variable = self.rbFontSize, value = 20)
        ...
        self.lbEntry1 = Listbox(self.listboxFrame, width = 29, height = 11, selectmode = BROWSE)
    ...
    def read(self):
        try:
            ...
            tkinter.messagebox.showerror("Read Error", "An error has appear while reading. Unable to Read")

    def edit(self):
        try:
            self.notepadList1[self.lbEntry1.curselection()[0]].manageInfo(1)
        except:
            tkinter.messagebox.showerror("Edit Error", "An error has appearred while editting. Unable to Edit")
    ...
    def delete(self):
        try:
            ...
            tkinter.messagebox.showerror("Delete Error", "An error has appeared while deleting. Unable to Delete")
